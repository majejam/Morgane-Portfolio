  ...
  <div class="home-container">
    ...
    <div v-if="markers" class="container">
      ...
      >
        <div
          class="img-container"
          v-if="marker['image']['sizes']['medium_large']"
        >
  ...
  mounted() {
    window.addEventListener("resize", () => {
      this.$refs.markers.forEach(element => {
        if (element) element.style.height = element.offsetWidth + "px";
      });
    });

    fetch(
      "https://www.morganelapisardi.fr/backoffice/index.php/wp-json/markers/v1/post"
    )
      .then(r => r.json())
      .then(res => {
